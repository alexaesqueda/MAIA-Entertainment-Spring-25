...
def ensure_logged_in():
    ...
    st.markdown(
       ...
       box-shadow: 0 10px 30px rgba(5, 150, 105, 0.3);'>
           <h2 style='color: white' !important; margin-bottom:16px !important; font-weight:800 !important; margin-top:0 !important; font-size: 6rem !important; text-shadow: 0 1px 3px rgba(0,0,0,0.3) !important;'>
               🎵 Welcome to Stanza!
           </h2>
